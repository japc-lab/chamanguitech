...
if (dbType === 'mongo') {
    ...
    merchantAdapter = new MongooseGenericAdapter(Merchant, ['person']); // If Merchant has a relation with Person
    fishermanAdapter = new MongooseGenericAdapter(Fisherman, ['person']); // If Fisherman has a relation with Person
    ...
    logisticsPaymentAdapter = new MongooseGenericAdapter(LogisticsPayment);
    ...
    localCompanySaleDetailAdapter = new MongooseGenericAdapter(LocalCompanySaleDetail);
    localCompanySaleDetailItemAdapter = new MongooseGenericAdapter(LocalCompanySaleDetailItem);
    localCompanySaleDetailPaymentAdapter = new MongooseGenericAdapter(LocalCompanySaleDetailPayment);
